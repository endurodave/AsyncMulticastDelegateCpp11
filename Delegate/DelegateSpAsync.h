...
public:
	...
	virtual DelegateMemberSpAsync<void(TClass(void))>* Clone() const {
...
public:
	...
	virtual DelegateMemberSpAsync<void(TClass(Param1))>* Clone() const {
...
public:
	...
	virtual DelegateMemberSpAsync<void(TClass(Param1, Param2))>* Clone() const {
...
public:
	...
	virtual DelegateMemberSpAsync<void(TClass(Param1, Param2, Param3))>* Clone() const {
...
public:
	...
	virtual DelegateMemberSpAsync<void(TClass(Param1, Param2, Param3, Param4))>* Clone() const {
...
public:
	...
	virtual DelegateMemberSpAsync<void(TClass(Param1, Param2, Param3, Param4, Param5))>* Clone() const {
